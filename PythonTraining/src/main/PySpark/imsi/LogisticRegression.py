...
#################################
# print the coefficients and intercept for lr
"""
The coefficients are from a model that contains 9 predictor variables. 
There are two different reasons why the number of predictors differs 
from the number of coefficients. 
The coefficient of the (Intercept) is unrelated to the number of predictors.
The second reason is that sometimes categorical predictors are represented by multiple coefficients.
"""
print("Coefficients: " + str(lrModel.coefficients))
print("Intercept: " + str(lrModel.intercept))

# map features with coefficients
# an explication exemple: https://www.displayr.com/how-to-interpret-logistic-regression-coefficients/?utm_referrer=https%3A%2F%2Fwww.google.com%2F
# the positive sign of a feature means
# that all else being equal,
# postpaid clients were more likely to have churned than prepaid clients.
attrs = sorted(
